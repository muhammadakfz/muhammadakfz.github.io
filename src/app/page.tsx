...
export default function Home() {
  ...
  return (
    <>
      ...
      <div id="about" className="h-[100vh] flex justify-center items-center" data-aos="fade-up">
        <div className='flex flex-row place-content-center content-center place-items-center'>
          <Image src="/pp.jpg" alt="Picture of the author" data-aos="fade-up" width={400} height={400} className='rounded-full border-[20px] border-solid border-white drop-shadow-2xl basis-1/4 rounded-full justify-end' />
