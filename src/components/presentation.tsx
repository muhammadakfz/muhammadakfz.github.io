...
export function Presentation() {
  ...
  const profile = {
    name: 'Muhammad Akhyar Fahrurrozi',
    age: '19 years old',
    location: 'Depok, Indonesia',
    // Add a newline character after the emoji
    description:
      "Hey 👋\nI'm Muhammad Akhayar Fahrurrozi. I'm working at Autonomous Marine Vehicle at University of Indonesia. I'm passionate about AI, tech, and Competitive Programming.",
    src: '/pp.jpeg',
    fallbackSrc:
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['AI', 'Developer', 'Competitive Programming', 'Backend', 'Physics'].map(
              (tag) => (
                <span
                  key={tag}
